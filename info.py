...
AUTH_CHANNEL = [int(auth_channels) for auth_channels in environ.get('AUTH_CHANNEL', '-1002224975092').split()]
if len(AUTH_CHANNEL) == 0:
    print('Info - AUTH_CHANNEL is empty')
LOG_CHANNEL = environ.get('LOG_CHANNEL', '-1002084963362')
...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://pq6svl:o1qQyMmy86Sz8Iej@cluster0.hx7srss.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
PM_DELETE_TIME = int(environ.get('PM_DELETE_TIME', 6000))
...
BIN_CHANNEL = environ.get("BIN_CHANNEL", "-1002023133714")
